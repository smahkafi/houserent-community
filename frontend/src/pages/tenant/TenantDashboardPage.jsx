      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-md">
            ...
            <p className="mt-1 text-xs text-slate-500">Total bookings made</p>
          </div>
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-md">
            <p className="text-sm text-slate-400">Active Rentals</p>
            <p className="mt-2 text-4xl font-bold text-emerald-300">0</p>
            <p className="mt-1 text-xs text-slate-500">Currently renting</p>
          </div>
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-md">
            <p className="text-sm text-slate-400">Agreements</p>
            <p className="mt-2 text-4xl font-bold text-emerald-300">0</p>
            <p className="mt-1 text-xs text-slate-500">Rental agreements</p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            >
              ...
              <div>
                <p className="font-semibold text-white">Browse Houses</p>
                <p className="text-sm text-slate-400">Find your next home</p>
              </div>
            </Link>
            <Link
              to="/tenant/bookings"
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">View booking status</p>
              </div>
            </Link>
            <Link
            ...
            >
              ...
              <div>
                <p className="font-semibold text-white">Agreements</p>
                <p className="text-sm text-slate-400">View rental agreements</p>
              </div>
            </Link>
            <Link
              to="/tenant/profile"
