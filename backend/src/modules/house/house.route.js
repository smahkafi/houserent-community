...
router.get(
  ...
  auth,
  role("SUPER_ADMIN"),
  houseController.getDeletedHouses
);
...
router.get(
  ...
  auth,
  role("SUPER_ADMIN"),
  houseController.getRestoreRequests
);
...
router.get(
  ...
  auth,
  role("SUPER_ADMIN"),
  houseController.getHouseAdminSummary
);
...
router.patch(
  ...
  auth,
  role("LANDLORD", "ADMIN", "SUPER_ADMIN"),
  houseController.softDeleteHouse
);
...
router.patch(
  ...
  auth,
  role("LANDLORD"),
  houseController.requestRestoreHouse
);
...
router.patch(
  ...
  auth,
  role("SUPER_ADMIN"),
  houseController.reviewRestoreRequest
);
...
router.delete(
  ...
  auth,
  role("SUPER_ADMIN"),
  houseController.permanentDeleteHouse
);
